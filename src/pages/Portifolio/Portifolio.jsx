    ...
    <main className={styles.main}>
      ...
      <div className={styles.div}>
        <div className={styles.info}>
          <h2>Coca Cola</h2>
          <p>
            A Coca-Cola é aquele sabor que ninguém consegue copiar. É a pedida
            certa pra juntar a galera, seja na pizza ou no churrasco. Trincando
            de gelada, com gelo e limão, é simplesmente o sinônimo mundial dos
            bons momentos.
          </p>
        </div>
      ...
      <div className={styles.div}>
        ...
        <div className={styles.info}>
          <h2>Parmegiana</h2>
          <p>
            Parmegiana é felicidade pura no prato! Um bife crocante, afogado no
            molho de tomate e com aquela camada absurda de queijo borbulhando
            por cima. Acompanhado do trio sagrado, arroz e batata frita, é o
            prato oficial do "hoje eu mereço".
          </p>
        </div>
      </div>
    </main>
